...
for tname in tlist[:1]:
	for ftype in range(1,4):
		...
		modelname=tname+'/'+'model_2_'+str(ftype)+'.pkl'
		print(dataname,modelname)
		loaddata = np.load(dataname)
		loaddata=np.delete(loaddata,[0,1,3],axis=1)
	...
	with warnings.catch_warnings():
		warnings.simplefilter("ignore")
		model0 = joblib.load("a1/model_2_0.pkl")
		model1= joblib.load("a1/model_2_1.pkl")
		model2= joblib.load("a1/model_2_2.pkl")
		model3= joblib.load("a1/model_2_3.pkl")
		model4= joblib.load("a1/model_2_4.pkl")
		n=0
		d=0
		acc=[0,0,0]
		recall=[0,0,0]
