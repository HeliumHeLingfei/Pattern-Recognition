...
for tname in tlist[:1]:
	for ftype in range(1,4):
		...
		loaddata=np.delete(loaddata,[1,2,3],axis=1)
	...
	with warnings.catch_warnings():
		warnings.simplefilter("ignore")
		model0 = joblib.load("a1/model_0_0.pkl")
		model1= joblib.load("a1/model_0_1.pkl")
		model2= joblib.load("a1/model_0_2.pkl")
		model3= joblib.load("a1/model_0_3.pkl")
		model4= joblib.load("a1/model_0_4.pkl")
		f=model2.n_features
		a=model2.transmat_
