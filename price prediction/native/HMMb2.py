...
for tname in tlist[2:3]:
	...
	with warnings.catch_warnings():
		warnings.simplefilter("ignore")
		model0 = joblib.load("b2/model0.pkl")
		model1= joblib.load("b2/model1.pkl")
		model2= joblib.load("b2/model2.pkl")
		model3= joblib.load("b2/model3.pkl")
		model4= joblib.load("b2/model4.pkl")
		n=0
		d=0
		acc=[0,0,0]
		recall=[0,0,0]
