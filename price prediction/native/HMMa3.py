...
for tname in tlist[1:2]:
	...
	with warnings.catch_warnings():
		warnings.simplefilter("ignore")
		model0 = joblib.load("a3/model0.pkl")
		model1= joblib.load("a3/model1.pkl")
		model2= joblib.load("a3/model2.pkl")
		model3= joblib.load("a3/model3.pkl")
		model4= joblib.load("a3/model4.pkl")
		n=0
		d=0
		acc=[0,0,0]
		recall=[0,0,0]
